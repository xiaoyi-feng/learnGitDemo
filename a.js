...
// 不会。原因git rm --cache a.js之后，我又执行了git add .
// ----------------
// 在add . 之后，commit 之前执行rm --cached
// push之后远程仓库原有的a.js文件消失不见了，原因是rm --cached使得a.js不再被git仓库控制
// （此时git status: a.js的状态是untracked, 一旦执行 git add .，就会再次进入版本控制）
// 即a.js从本地git仓库中被“移除”了，接着这一“移除”被同步更新到了远程仓库
// -------------------
// 接着只配置.gitignore，a.js仍在git版本控制之中
// check gitignore文件配置是否生效